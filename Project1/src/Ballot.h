...
class Ballot {  // : public Reporter {
 public:
 /**
  * @brief Default constructor for development phase. Constructs a ballot with no input
  *
  *
  * @param[in] none
  * @param[in] none
  ...
  */
  Ballot() {};
  Ballot(const Ballot &); // copy constructor
  Ballot & operator = (const Ballot &); // copy operator
  Ballot* operator = (Ballot *b) 
  { 
    return this; 
  }; 
  /**
