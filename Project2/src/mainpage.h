 ...
 *
 * The Voting System is an application for use by election officials to take
 * comma-separated value (csv) files representing candidates, rankings
 * representing individualy ballots, and the number of seat available for
 * election, and to run a plurality election or a single transferable vote (STV,
