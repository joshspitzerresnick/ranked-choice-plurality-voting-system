...
class PluralityElectionRecordTests : public ::testing::Test {
 protected:
  ...
  virtual void SetUp() {
    ...
    ballot1 = new Ballot(1, {1}, {1});
    ballot2 = new Ballot(2, {1}, {1});
    ballot3 = new Ballot(3, {1}, {1});
    ballot4 = new Ballot(4, {2}, {2});
    ballot5 = new Ballot(5, {2}, {2});
...
TEST_F(PluralityElectionRecordTests, SortNonElectedCandidateList_reorder) {
  ...
  ballot1_reorder = new Ballot(1, {2}, {2});
  ballot2_reorder = new Ballot(2, {3}, {3});
  ballot3_reorder = new Ballot(3, {5}, {5});
  ballot4_reorder = new Ballot(4, {5}, {5});
  ballot5_reorder = new Ballot(5, {5}, {5});
