...
virtual void SetUp() {
  ...
  ballot1 = new Ballot(1, {0}, {0});
  ballot2 = new Ballot(2, {0}, {0});
  ballot3 = new Ballot(3, {0}, {0});
  ballot4 = new Ballot(4, {0}, {0});
  ballot5 = new Ballot(5, {0}, {0});
...
TEST_F(STVElectionRecordTests, SortNonElectedCandidateList) {
  ...
  candidate5 = new STVCandidate(5, "Tim", "center");
  ballot1 = new Ballot(1, {0}, {0});
  ballot2 = new Ballot(2, {1}, {0});
  ballot3 = new Ballot(3, {1}, {0});
  ballot4 = new Ballot(4, {1}, {0});
  ballot5 = new Ballot(5, {2}, {0});
  candidates.push_front(candidate0);
  candidates.push_front(candidate1);
  candidates.push_front(candidate2);
  candidates.push_front(candidate3);
